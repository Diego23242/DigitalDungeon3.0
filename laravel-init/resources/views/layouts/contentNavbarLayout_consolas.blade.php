    ...
    <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-4">
                    <a href="{{ route('xbox') }}" class="card-link">
                        <div class="card">
                            <img src="https://cdn.hobbyconsolas.com/sites/navi.axelspringer.es/public/media/image/2023/06/xbox-3057336.jpg?tf=3840x" class="card-img-top" alt="Juego 1">
                            <div class="card-body">
                ...
                <div class="col-lg-6 col-md-6 mb-4">
                    <a href="{{ route('playstation') }}" class="card-link">
                        <div class="card">
                            <img src="{{asset('assets/img/PlayStation.jpg ')}}" class="card-img-top" alt="Juego 1">
                            <div class="card-body">
